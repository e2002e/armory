...
class ArmRPListItem(bpy.types.PropertyGroup):
    ...
    arm_voxelgi_shad: FloatProperty(name="Constrast", description="", default=1.0, update=assets.invalidate_shader_cache)
    ...
    arm_ss_refraction_jitter: FloatProperty(name="Jitter", default=0.25, update=assets.invalidate_shader_cache)
